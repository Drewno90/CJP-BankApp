...
public class ClientInfoRequest implements Request {
	...
	public String execute() {
		...
		return new StringBuffer().append("Client name=").append(BankCommander.currentClient.getName())
				.append(", accounts=").append(BankCommander.currentClient.getAccounts()).append(", activeAccount=")
				.append(BankCommander.currentClient.getActiveAccount()).append(", initialOverdraft=")
				.append(BankCommander.currentClient.getInitialOverdraft()).append(", clientGender=")
				.append(BankCommander.currentClient.getClientGender()).toString();
