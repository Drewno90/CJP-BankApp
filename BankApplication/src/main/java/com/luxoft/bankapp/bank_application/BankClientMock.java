...
public class BankClientMock extends BankClient implements Callable<Long> {
	...
	// message = (String) in.readObject();
	// WithdrawRequest withdrawRequest = new WithdrawRequest(ammount,
	// bankService,BankCommander.currentClient.getName());
	...
	public Long call() throws Exception {
		...
		try {
			...
			sendRequest(new LogInRequest(BankCommander.currentClient.getName()));
			message = (String) in.readObject();
			WithdrawRequest withdrawRequest = new WithdrawRequest(ammount, bankService,
