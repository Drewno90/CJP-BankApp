...
public class TestRequest {
	...
	public void withdrawRequestTest() {
		double ammount = bankService.findClientByHisName(BankCommander.currentBank, clientName).getActiveAccount()
				.getBalance();
		request = new WithdrawRequest(100f, bankService, clientName);
		request.execute();
		double ammount2 = bankService.findClientByHisName(BankCommander.currentBank, clientName).getActiveAccount()
				.getBalance();
